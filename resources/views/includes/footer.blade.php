                ...
                <div class="padding-30px-left sm-no-padding-left">
                    ...
                    <form>
                        <div class="form-group footer-subscribe">
                            ...
                            <a class="butn theme"><span>Join</span></a>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left xs-text-center xs-margin-5px-bottom">
                    <p>&copy; Copyright Ewings 2021. All Rights Reserved.</p>
                </div>
...
<!-- end footer section -->
<!-- start footer section -->
<footer class="border-top bg-light border-color-light-gray padding-70px-top">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 sm-margin-30px-bottom">
                <img class="width-60 sm-width-40" src="{{ asset('img/logo-dark.png') }}" alt="" />
                <p class="margin-20px-top text-dark-gray width-90 xs-width-100">Nemo enim enim voluptatem quia voluptas
                    sit aspernatur aut odit aut fugit, sed quia consequ magni dolores eos qui ratione.</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="padding-30px-left md-padding-25px-left sm-no-padding-left">
                    ...
                    <p class="no-margin-bottom text-dark-gray">Nemo enim enim voluptatem quia voluptas sit aspernatur
                        aut odit aut fugit, sed quia consequr.</p>
                    <form>
                        <div class="form-group footer-subscribe2">
                            <input type="email" placeholder="Subscribe with us" id="Email1"
    ...
    <div class="footer-bar bg-white xs-font-size13 border-top border-color-light-gray">
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-left xs-text-center xs-margin-5px-bottom text-dark-gray sm-font-size13">
                    <p>© Copyright Ewings 2021. All Rights Reserved.</p>
                </div>
