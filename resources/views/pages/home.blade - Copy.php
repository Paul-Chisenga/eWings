...
@section('content')
    ...
    <div class="container-fluid full-screen">
        <div class="row slider-fade">
            <div class="owl-carousel owl-theme">
                ...
                <div class="text-center item bg-img" data-overlay-dark="4" data-background="img/placeholders/ewings-08.jpg">
                    <div class="display-table height-100 position-relative caption">
                        <div class="display-table-cell vertical-align-middle">
                            <div class="container">
                                <h2 class="text-white px-5">Welcome to the home of Aviation Training and Consulting </h2>
                                {{-- <p class="text-white margin-40px-bottom md-margin-30px-bottom xs-margin-25px-bottom center-col">
    ...
    <section class="courses-area">
        <div class="container">
            <div class="row">
                <div class="col-12 center-col margin-50px-bottom md-margin-40px-bottom text-center">
                    <h3 class="font-weight-500 font-size32 md-font-size28 sm-font-size26 xs-font-size24 section-title">Our
                        Solutions</h3>
                ...
                <div class="row row-cols-3">
                    <div class="col">
                        <div class="card" style="width: 18rem;">
                            <img src="img/courses/courses_thumb_01.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h4 class="font-size22 md-font-size20 sm-font-size18 margin-10px-bottom font-weight-500 text-theme-color">Unmanned Aircraft Systems</h4>
                                <p class="font-size15 xs-font-size14 line-height-28">Some quick example text to build on the card title and make up the bulk
                ...
                <div class="owl-carousel owl-theme">
                    <div class="courses-box">
                        <div class="courses-pic position-relative">
                            <a href="course-details.html"><img src="img/courses/courses_thumb_01.jpg" alt="" /></a>
                        </div>
                            ...
                            <div class="courses-desc last-paragraph-no-margin">
                                <div class="courses-title">
                                    <h4 class="font-size22 md-font-size20 sm-font-size18 margin-5px-bottom font-weight-500">
                                        <a href="course-details.html" class="text-theme-color">Computer Science</a>
                                    </h4>
                                </div>
                                <div class="course-review margin-15px-bottom">
                                ...
                                <p class="font-size15 xs-font-size14 line-height-28">Excepteur sint occaecat cupidatat non
                                    proident, sunt in culpa qui officia deserunt laborum. </p>
                            </div>
                        </div>
                    ...
                    <div class="courses-box">
                        <div class="courses-pic position-relative">
                            <a href="course-details.html"><img src="img/courses/courses_thumb_02.jpg" alt="" /></a>
                        </div>
                        <div class="course-main-content">
                            <div class="courses-desc last-paragraph-no-margin">
                                <div class="courses-title">
                                    <h4 class="font-size22 md-font-size20 sm-font-size18 margin-5px-bottom font-weight-500">
                                        <a href="course-details.html" class="text-theme-color">Marketing Business</a>
                                    </h4>
                                </div>
                                <div class="course-review margin-15px-bottom">
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="courses-box">
                        <div class="courses-pic position-relative">
                            <a href="course-details.html"><img src="img/courses/courses_thumb_03.jpg" alt="" /></a>
                        </div>
                        <div class="course-main-content">
                            <div class="courses-desc last-paragraph-no-margin">
                                <div class="courses-title">
                                    <h4 class="font-size22 md-font-size20 sm-font-size18 margin-5px-bottom font-weight-500">
                                        <a href="course-details.html" class="text-theme-color">Architecture Design</a>
                                    </h4>
                                </div>
                                <div class="course-review margin-15px-bottom">
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="courses-box">
                        <div class="courses-pic position-relative">
                            <a href="course-details.html"><img src="img/courses/courses_thumb_04.jpg" alt="" /></a>
                        </div>
                        <div class="course-main-content">
                            <div class="courses-desc last-paragraph-no-margin">
                                <div class="courses-title">
                                    <h4 class="font-size22 md-font-size20 sm-font-size18 margin-5px-bottom font-weight-500">
                                        <a href="course-details.html" class="text-theme-color">Medical Technology</a>
                                    </h4>
                                </div>
                                <div class="course-review margin-15px-bottom">
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="courses-box">
                        <div class="courses-pic position-relative">
                            <a href="course-details.html"><img src="img/courses/courses_thumb_05.jpg" alt="" /></a>
                        </div>
                        <div class="course-main-content">
                            <div class="courses-desc last-paragraph-no-margin">
                                <div class="courses-title">
                                    <h4 class="font-size22 md-font-size20 sm-font-size18 margin-5px-bottom font-weight-500">
                                        <a href="course-details.html" class="text-theme-color">Microsoft Azure</a>
                                    </h4>
                                </div>
                                <div class="course-review margin-15px-bottom">
                                    <i class="fas fa-star"></i>
                    ...
                    <div class="courses-box">
                        <div class="courses-pic position-relative">
                            <a href="course-details.html"><img src="img/courses/courses_thumb_06.jpg" alt="" /></a>
                        </div>
                        <div class="course-main-content">
                            <div class="courses-desc last-paragraph-no-margin">
                                <div class="courses-title">
                                    <h4 class="font-size22 md-font-size20 sm-font-size18 margin-5px-bottom font-weight-500">
                                        <a href="course-details.html" class="text-theme-color">Android Apps</a>
                                    </h4>
                                </div>
                                <div class="course-review margin-15px-bottom">
                                    <i class="fas fa-star"></i>
                ...
                <div class="col-lg-5 col-sm-12 order-1 order-lg-2 sm-margin-40px-bottom xs-margin-30px-bottom">
                    <div class="row">
                        <div class="col-md-12 xs-margin-25px-bottom">
                            <div class="xs-text-center">
                                <img src="{{ asset('img/placeholders/ewings-01.jpg') }}" alt="" class="border-radius-6" />
                            </div>
                        </div>
                        {{-- <div class="col-md-5">
                            <div class="about-img">
                        ...
                        <div class="col-md-12">
                            <div class="about-img">
                                <img src="{{ asset('img/placeholders/ewings-02.jpg') }}" alt=""
                                    class="margin-30px-bottom sm-margin-25px-bottom border-radius-6" />
                                <img src="{{ asset('img/placeholders/ewings-03.jpg') }}" alt="" class="border-radius-6" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-sm-12 order-1 order-lg-2 sm-margin-40px-bottom xs-margin-30px-bottom">
                    <div class="row">
                        <div class="col-md-7 xs-margin-25px-bottom">
                            <div class="xs-text-center">
                                <img src="{{ asset('img/placeholders/ewings-04.jpg') }}" alt="" class="border-radius-6" />
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="about-img">
                                <img src="{{ asset('img/placeholders/ewings-05.jpg') }}" alt=""
                                    class="margin-30px-bottom sm-margin-25px-bottom border-radius-6" />
                                <img src="{{ asset('img/placeholders/ewings-06.jpg') }}" alt="" class="border-radius-6" />
                            </div>
                        </div>
                    </div>
                </div>
