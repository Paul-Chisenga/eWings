            ...
            <div class="row align-items-center">
                <div class="col-lg-5 col-sm-12 order-2 order-lg-1">
                    <div class="padding-50px-right md-padding-40px-right sm-no-padding-right">
                        ...
                        <a class="butn fill margin-30px-top md-margin-25px-top sm-margin-20px-top" href="/about">Read More
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 center-col margin-50px-bottom sm-margin-40px-bottom text-center">
                    <h3 class="font-weight-500 font-size32 md-font-size28 sm-font-size26 xs-font-size24 section-title">What
                        Parents Say</h3>
            ...
            <div class="testimonial-style1 owl-theme owl-carousel" data-slider-id="1">
                <div class="text-center">
                    <div class="testmonial-text">
                        <p
                            class="font-size18 sm-font-size16 line-height-35 xs-line-height-28 margin-30px-bottom sm-margin-25px-bottom xs-margin-20px-bottom">
                            Perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                            rem aperiam, eaque inventore veritatis et quasi architecto beatae.</p>
                        <h5 class="margin-5px-bottom font-size18 xs-font-size16"><a href="#" class="text-theme-color">Stepha
                                Kruse</a></h5>
                        <h6 class="font-size14 xs-font-size13 letter-spacing-1 font-weight-500 opacity6 no-margin-bottom">
                            Designer</h6>
                    </div>
                </div>
                <div class="text-center">
                    <div class="testmonial-text">
                        <p
                            class="font-size18 sm-font-size16 line-height-35 xs-line-height-28 margin-30px-bottom sm-margin-25px-bottom xs-margin-20px-bottom">
                            Aerspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                            rem aperiam, eaque inventore veritatis et quasi architecto beatae.</p>
                        <h5 class="margin-5px-bottom font-size18 xs-font-size16"><a href="#"
                                class="text-theme-color">Dunican keithly</a></h5>
                        <h6 class="font-size14 xs-font-size13 letter-spacing-1 font-weight-500 opacity6 no-margin-bottom">
                            Networking</h6>
                    </div>
                </div>
                <div class="text-center">
                    <div class="testmonial-text">
                        <p
                            class="font-size18 sm-font-size16 line-height-35 xs-line-height-28 margin-30px-bottom sm-margin-25px-bottom xs-margin-20px-bottom">
                            Rerspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam
                            rem aperiam, eaque inventore veritatis et quasi architecto beatae.</p>
                        <h5 class="margin-5px-bottom font-size18 xs-font-size16"><a href="#" class="text-theme-color">Alivin
                                Corondo</a></h5>
                        <h6 class="font-size14 xs-font-size13 letter-spacing-1 font-weight-500 opacity6 no-margin-bottom">
                            Developer</h6>
                    </div>
            ...
            <div class="owl-thumbs text-center" data-slider-id="1">
                <button class="owl-thumb-item border-radius-50 width-60px sm-width-50px xs-width-40px margin-5px-right"><img
                        src="{{ asset('img/testmonials/t-7.jpg') }}" class="border-radius-50" alt="" /></button>
                <button class="owl-thumb-item width-60px border-radius-50 sm-width-50px xs-width-40px margin-5px-right"><img
                        src="{{ asset('img/testmonials/t-8.jpg') }}" class="border-radius-50" alt="" /></button>
                <button class="owl-thumb-item width-60px sm-width-50px xs-width-40px border-radius-50"><img
                        src="{{ asset('img/testmonials/t-9.jpg') }}" class="border-radius-50" alt="" /></button>
            </div>
        </div>
    </section>
                        ...
                        <div class="team-image position-relative display-block overflow-hidden">
                            ...
                            <div class="overlay-box">
                                <ul class="social-icons no-margin-bottom">
                                    ...
                                    <li><a href="javascript:void(0)"><span><i class="fab fa-linkedin-in"></i></span></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="team-info padding-20px-tb md-padding-15px-tb padding-5px-lr text-center">
                            <h5 class=" font-size20 sm-font-size18 text-theme-color margin-5px-bottom sm-no-margin-bottom">
                                Matide V. Sousa</h5>
